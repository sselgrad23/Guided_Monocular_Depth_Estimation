...
WORKING_DIRECTORY="$HOME/diffusers"
...
export EVAL_DATASET="$HOME/eval_dataset/diode/diode_val"
export OUTPUT_DIR="$CONTROLNET_DIR/0909/output_N_${N}_PROPER_CKPT_${CKPT}_SCALE_${SCALE}/diode"
