...
export EVAL_DATASET="$SCRATCH_DIRECTORY/eval_dataset/nyuv2/nyu_labeled_extracted"
export OUTPUT_DIR="$CONTROLNET_DIR/0810/output_N_${N}_PROPER_CKPT_${CKPT}_SCALE_${SCALE}/nyuv2"
...
python infer_inpaint.py \
     ...
     --depth_min 1e-3 \
     --depth_max 10.0
echo "🎇 Inference NYUv2 train and test set, ${N} points, Checkpoint ${CKPT} complete"