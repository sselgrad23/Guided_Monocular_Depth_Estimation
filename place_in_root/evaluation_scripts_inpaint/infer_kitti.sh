...
export OUTPUT_DIR="$CONTROLNET_DIR/0810/output_N_${N}_PROPER_CKPT_${CKPT}_SCALE_${SCALE}/kitti"
...
python infer_inpaint.py \
     ...
     --split_file "$EVAL_DATASET/kitti_${N}.txt" \
     ...
     --depth_min 1e-5 \
     --depth_max 80.0
echo "🎇 Inference kitti, ${N} points, Checkpoint ${CKPT} complete"