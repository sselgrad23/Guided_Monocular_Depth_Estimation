...
print(">>> controlnet.py imported")
logger.info(">>> controlnet.py imported (logger)")
...
class ControlNetConditioningEmbedding(nn.Module):
    ...
    def __init__(
        ...
        for i in range(len(block_out_channels) - 1):
            ...
            self.blocks.append(nn.Conv2d(channel_in, channel_out, kernel_size=3, padding=1, stride=2)) # I would apply the function to change the stride (but I don't change the code here)
...
class ControlNetModel(ModelMixin, ConfigMixin, FromOriginalModelMixin):
    ...
    def __init__(
        self,
        in_channels: int = 8,
        conditioning_channels: int = 9, #3, # We need to change this to 5 for the
    ...
    def forward(
        ...
        controlnet_output = ControlNetOutput(
            down_block_res_samples=down_block_res_samples, mid_block_res_sample=mid_block_res_sample
        )
        logger.info(f"controlnet_output shape: {controlnet_output.mid_block_res_sample.shape}")
